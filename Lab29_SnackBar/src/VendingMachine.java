...
public class VendingMachine extends JPanel implements ActionListener {
	...
	private JButton deposit100c, deposit25c, deposit10c, deposit5c, go, getChange;
	...
	public VendingMachine(String brand, Color color, int price, ImageIcon coin) {
		...
		getChange = new JButton(" Get Change ", coin);
		getChange.addActionListener(this);
		deposit100c = new JButton(" 100 ", coin);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (b == getChange) {
			int change = vendor.returnChange();
			repaint();
			JOptionPane.showMessageDialog(null, "Here's your " + change + "c" + "\n",
					"Enjoy Your Money!", JOptionPane.PLAIN_MESSAGE);
		}
