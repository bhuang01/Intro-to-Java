...
/*
 * Experimentation: Added a machine that sells Bitcoin
 */
...
public class SnackBar extends JFrame implements ActionListener {
	...
	public SnackBar() {
		...
		Color brandColor4 = new Color(51, 178, 255);
		...
		machine4 = new VendingMachine("Bitcoin", brandColor4, 1000, coin);
	...
	public static void main(String[] args) {
		...
		window.setBounds(50, 50, 1000, 310);
