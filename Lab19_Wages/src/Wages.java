 ...
 * Author: Bryan H.
 * Date: 11/28/18
 * Description: Returns the total wages that is earned from a certain number of hours and earnings per hour
 * Version: 
 * Version Notes:
 */
    ...
    implements ActionListener
{
  ...
  public double totalWages(double hours, double rate)
  {
    ...
    if (hours <= 40) wages = wages + rate * 40;
    else if (hours > 40) {
    	double extraPayHours = hours - 40;
    	wages += 40 * rate;
    	wages += extraPayHours * (1.5 * rate);
    }
