...
public class LipogramTester {
	...
	private static final String MARKEDRESULT03 = "how do#s your lipogramm#r s##k l#tt#rs? "
			+ "this v#rsion has a f#w r#p#at#d words (and a f#w words with mor# than on# bann#d " + "l#tt#r too)";
	...
	private static final String TESTSAMPLE04 = "Technically, your LipogramAnalyzer should work"
			+ " even if there are repeated words that contain the banned letter, or possibly even" + " punctuation!\r\n"
	...
	private static final String MARKEDRESULT04 = "t#chnically, your lipogramanalyz#r should work "
			+ "#v#n if th#r# ar# r#p#at#d words that contain th# bann#d l#tt#r, or possibly #v#n " + "punctuation!\r\n"
	...
	// test samples with results
	// test 05
	private static final String TESTSAMPLE05 = "Technically, your LipogramAnalyzer should work even if there are "
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Compare: " + analyzer01.allWordsWith(OFFENDINGLETTER).trim().compareTo(WORDLISTRESULT01.trim()));
		...
		System.out.println(
				"Compare: " + analyzer02.allWordsWith(OFFENDINGLETTER).trim().compareTo(WORDLISTRESULT02.trim()));
		...
		System.out.println(
				"Compare: " + analyzer03.allWordsWith(OFFENDINGLETTER).trim().compareTo(WORDLISTRESULT03.trim()));
		...
		System.out.println(
				"Compare: " + analyzer04.allWordsWith(OFFENDINGLETTER).trim().compareTo(WORDLISTRESULT04.trim()));
		...
		System.out.println(
				"Compare: " + analyzer05.allWordsWith(OFFENDINGLETTER).trim().compareTo(WORDLISTRESULT05.trim()));
